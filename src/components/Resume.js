                                    ...
                                    <div className="columns main">
                                        <div className="twelve rows">
                                            ...
                                            <p className="info">
                                                {item.CompanyName}
                                                <span>&bull;</span>{' '}
                                                <em className="location">{item.Location}</em>
                                ...
                                <div className="row item hidden" key={i}>
                                    ...
                                    <div className="columns main">
                                        <div className="twelve rows">
                                            ...
                                            <p className="grades">{item.Grades}</p>
                                ...
                                return (
                                    <div className="card" key={i}>
                                        <div
                                            ...
                                            style={{
                                                background: `linear-gradient(to bottom, rgba(66, 76, 92, 0.8) 0%, rgba(66, 76, 92, 0.8) 100%), url('${item.Image}'), #333`,
                                        ...
                                        >
                                            <div className="row title header">
                                                <p>
                                                    <em className="cardDate">{item.StartDate}</em>
                                                </p>
                                            </div>
